...
function OnePost() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const res = await fetch("http://18.191.203.77/api/comments");
        const jsonData = await res.json();
        // sort the array by createdAt property ordered by descending values
        const data = jsonData.sort((a, b) =>
          a.createdAt < b.createdAt ? 1 : -1
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const res = await fetch("http://18.191.203.77/api/replys");
        const jsonData = await res.json();
        // sort the array by createdAt property ordered by descending values
        const data = jsonData.sort((a, b) =>
          a.createdAt < b.createdAt ? 1 : -1
  ...
  useEffect(() => {
    ...
    const fetchPostLikes = async () => {
      try {
        ...
        const res = await fetch(`http://18.191.203.77/api/likes/${userParam}`);
  ...
  const renderPosts = (post) => {
    ...
    const likePost = () => {
      ...
      const recordLike = async () => {
        const res = await fetch(`http://18.191.203.77/api/likes/`, {
          method: "POST",
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
